...
dataFrame.mean().to_csv("data/mean_data.csv", index=False)
dataFrame.std().to_csv("data/standardised_deviation_data.csv", index=False)
dataFrame_scaled.to_csv("data/standardised_data.csv", index=False)
